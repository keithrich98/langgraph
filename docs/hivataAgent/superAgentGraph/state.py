...
class ChatState:
    ...
    # We lazily import get_questions to break the circular dependency.
    questions: List[Dict] = field(default_factory=lambda: __import__("default_questions").get_questions())
